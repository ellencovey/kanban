...
class BoardCollectionViewCell: UICollectionViewCell {
    ...
    @IBOutlet weak var tableView: UITableView! // this connection was forgotten in tutorial
    weak var parentVC: BoardCollectionViewController? // setting vc class in storyboard was forgotten in tutorial
    var board: Board?
